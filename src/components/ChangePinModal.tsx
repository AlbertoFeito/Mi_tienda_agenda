...
export default function ChangePinModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[600] bg-gradient-to-b from-[#0F766E] to-[#134E4A] text-white flex flex-col items-center justify-center px-8">
      <button
        onClick={onClose}
        className="absolute top-4 right-4 p-2 active:scale-95 transition-transform"
        aria-label="Cerrar"
      >
        <X size={24} />
      </button>
