...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Le puedes poner una foto al cliente: en una lista larga se reconoce antes una cara que un nombre.',
      'Con “Importar” metes de golpe una lista de clientes desde un archivo .csv: el que exporta Google Contacts, o uno hecho en Excel con las columnas Nombre, Teléfono, Dirección y Notas.',
      'Antes de guardar nada te dice cuántos va a agregar y cuántos ya tenías. Los repetidos se saltan, así que puedes importar el mismo archivo dos veces sin duplicar a nadie.',
    ],
    keywords: [
      'clientes',
      'deuda',
  ...
  },
  {
    ...
    notes: [
      ...
      'En la pestaña “Tienda” hay una “Moneda de referencia”. Eso no cambia las cuentas: solo añade debajo de las cifras grandes cuánto sería en esa moneda al cambio de hoy, para que te hagas una idea.',
    ],
    keywords: ['moneda', 'tasa', 'cambio', 'usd', 'euro', 'mlc', 'cup', 'dólar', 'referencia', 'equivalencia'],
  },
  {
    id: 'tienda',
    title: 'Datos de la tienda y logo',
    summary: 'El nombre, el teléfono y la dirección que pones aquí son los que salen en la cabecera y en los recibos que le mandas al cliente.',
    steps: [
      'Entra en Configuración → pestaña “Tienda”.',
      'Toca el cuadro de la foto para poner el logo: puedes tirarlo con la cámara o buscarlo en la galería.',
      'Pon el nombre, el teléfono y la dirección.',
      'Toca “Guardar”: se guarda y vuelve sola a la tienda.',
    ],
    notes: [
      'El logo se ve arriba, al lado del nombre, y en la pantalla del recibo.',
      'El recibo que se manda por WhatsApp o SMS es texto y no lleva imagen, así que ahí sale el nombre pero no el logo.',
    ],
    keywords: ['tienda', 'logo', 'nombre', 'foto', 'imagen', 'cabecera', 'datos', 'recibo'],
  },
  {
    id: 'copia',
  ...
  },
  {
    ...
    notes: [
      'Si activas la huella, el PIN sigue funcionando por si el lector falla.',
      'Si sales de la app un momento —para mandar un recibo por WhatsApp, por ejemplo— y vuelves antes de cinco minutos, no te lo vuelve a pedir.',
    ],
